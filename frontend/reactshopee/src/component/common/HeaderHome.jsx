      ...
      return (
        <li className="navbar__link navbar__link--tappable navbar__link--hoverable navbar__link--account">
          <div className="stardust-popover" id="stardust-popover1" tabIndex={0}>
            <div style={{marginTop: "5px"}} role="button" className="stardust-popover__target">
              <div onClick={handhideShow} className="navbar__link--account__container">
                ...
                <div className="navbar__username">{localStorage.getItem("username")}</div>
              </div>
            </div>
              {
                isShow === true && (
                <div className="header__home--user" style={{position: "absolute", top: "4vh", right: "-7vw", color: "black", padding: "0 9px 1px", width: "121.48px",  height: "100.8px"}}>
                      <ul style={{marginLeft: "-4px",marginTop: 0, listStyle: "none",backgroundColor: "white", padding: 0}}>
                      <li><Link style={{color: "black"}} to="/profile">Tài khoản của tôi</Link></li>
                      <li><Link style={{color: "black"}} onClick={Logout} to="#">Đăng xuất</Link></li>
                    </ul>
                </div>
                )
              }
    ...
    <header className="shopee-top shopee-top--sticky">
          ...
          <div className="flex v-center FAQGyh">
            <Link to="/loginsell">
              <a
                ...
                className="_2TLLZP ZUq1cc"
              >
                Kênh Người Bán
              </a>
            </Link>
            <div className="shopee-drawer ZUq1cc" id="pc-drawer-id-0">
              <Link to="/app">
                <a
                  className="_2TLLZP"
                  href="#st"
      ...
      <div className="container-wrapper header-with-search-wrapper">
        <div className="container header-with-search">
          <a className="header-with-search__logo-section" href="#st">

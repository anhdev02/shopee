...
export class Cart extends Component {
  ...
  loadDataCart(){
    ...
    // console.log(store.getState().cart.numberCart)
                  ...
                  <div className="_1GcTXp">
                    ...
                    <div className="_2pPbjQ">
                      <div className="YxpsCR">
                        <Link title="Áo Blazer Nam Dài, Áo khoác Blazer Form Rộng phong cách Hàn Quốc UT" to="/error"><div className="_3SWf-5" style={{backgroundImage: 'url('+product.image+')'}} /></Link>
                        <div className="_3OrWGt">
                          <Link className="_2fQT1K">{product.name}</Link>
                    ...
                    <div className="Ra8lP2">
                      <div>
                        <span className="_1CXksa">{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(product.unit_price)}</span>
                      </div>
                    </div>
                    ...
                    <div className="dn3H7Y"><span>{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(product.unit_price*product.quantity)}</span></div>
                  ...
                  <div className="container">
                    <div style={{display: 'flex', alignItems: 'center'}}>
                      <div className="cart-page-header">
                        <Link className="cart-page-logo" to="/"><div />
                          ...
                          <div className="cart-page-logo__page-name">Giỏ hàng</div></Link>
                      </div>
                      <div className="cart-page-searchbar">
                        <div className="shopee-searchbar" aria-expanded="false" aria-owns="shopee-searchbar-listbox">
                          <div className="shopee-searchbar__main">
                            <form role="search" className="shopee-searchbar-input" autoComplete="off">
                              <input aria-label="10.10 SĂN MÃ FREESHIP 0Đ" className="shopee-searchbar-input__input" maxLength={128} autoComplete="off" aria-autocomplete="list" aria-controls="shopee-searchbar-listbox" />
                            </form>
                          </div>
                  ...
                  <div className="_2jol0L _3GVi82">
                    ...
                    <div className="W2HjBQ zzOmij">
                      ...
                      <button className="_28e55C clear-btn-style">
                        Chọn Tất Cả ({totalItem})</button><button className="clear-btn-style j9RJQY">Xóa</button>
                      <div className />
                          ...
                          <div className="_2BT_es">
                            <div className="_3BPMNN">
                              <div className="_2LMWss">
                                ...
                                <div className="nBHs8H">{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(totalPriceSum)}</div>
                              </div>
                  ...
                  <div className="_14jjyT">
                    <div style={{display: 'contents'}}>
                      ...
                      <div className="ED6Nfy row">
                        <div className="F5GEoY col-xs-2">
                          <Link data-sqe="link" to="/error"><div className="MHQUWx">
                                  ...
                                  <div className="_6WqAAN kSGaAZ">
                                    ...
                                    <div className="_1q4RI2">
                                      <div className="customized-overlay-image">
                                        <img alt="" src="https://cf.shopee.vn/file/420b9e4b274b84e51e1bb6ceca62eb3c" width height />
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="e+W1+o">
                                <div style={{pointerEvents: 'none'}}>
                                  <div className="_6WqAAN kSGaAZ">
                                    ...
                                    <div className="_1q4RI2">
                                      <div className="customized-overlay-image">
                                        <img alt="" src="https://cf.shopee.vn/file/55b5fcc238686797765af4a9d75f4a0f" width height />
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="e+W1+o">
                                <div style={{pointerEvents: 'none'}}>
                                  <div className="_6WqAAN kSGaAZ">
                                    ...
                                    <div className="_1q4RI2">
                                      <div className="customized-overlay-image">
                                        <img alt="" src="https://cf.shopee.vn/file/651abc9a9f61b4c68c2e1c7c49415083" width height />
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="e+W1+o">
                                <div style={{pointerEvents: 'none'}}>
                                  <div className="_6WqAAN kSGaAZ">
                                    ...
                                    <div className="_1q4RI2">
                                      <div className="customized-overlay-image">
                                        <img alt="" src="https://cf.shopee.vn/file/94fe1b0731631626089656dd2ce2dcf8" width height />
                                      </div>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div className="alAWLq">
                      ...
                      <div className="_2QKwIt">
                        <Link index={0} className="_3J-9cq" to="/error"><div className="_1Zpa2f">
                            <div className="_2TafGB _1NNc5R">
                              <img alt="" width="invalid-value" height="invalid-value" className="Q2TwgS" style={{objectFit: 'contain'}} src="https://cf.shopee.vn/file/dad6bc23db9b9b1882ada4c85aacb16f_tn" />
                            </div>
                          </div>
                          <div className="_24FucX">₫189.000</div></Link><Link index={1} className="_3J-9cq" to="/error"><div className="_1Zpa2f">
                            <div className="_2TafGB _1NNc5R">
                              <img alt="" width="invalid-value" height="invalid-value" className="Q2TwgS" style={{objectFit: 'contain'}} src="https://cf.shopee.vn/file/3b88d6c8e65079c9a438386abafe5941_tn" />
                            </div>
                          </div>
                          <div className="_24FucX">₫279.000</div></Link><Link index={2} className="_3J-9cq" to="/error"><div className="_1Zpa2f">
                            <div className="_2TafGB _1NNc5R">
                              <img alt="" width="invalid-value" height="invalid-value" className="Q2TwgS" style={{objectFit: 'contain'}} src="https://cf.shopee.vn/file/39ba55af4ef2c88080163ecb7a478a13_tn" />
                            </div>
                          </div>
                          <div className="_24FucX">₫249.000</div></Link>
                      </div>
                    </div>
                  </div>
                </div>

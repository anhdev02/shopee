...
import MallDepartment from "../product/mall/MallDepartment";


class MallDepartmentPage extends Component {
  render() {
    return (
      <div div className="react_mall">
        <svg
...
export default MallDepartmentPage;
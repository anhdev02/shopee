...
export class ProductByBrand extends Component{
    constructor(props) {
        super(props);
        this.state = {
          id: this.props.id,
      ...
      getData() {
        axios.get(AppUrl.ProductByBrand+this.props.id)
          .then((response) => {
            var data = response.data;
            this.setState({
                ProductBrandArray: data
            });
          })
          .catch((error) => {
            console.log(error);
      ...
      render() {
        var ProductBrandArray = this.state.ProductBrandArray;
        var myview = ProductBrandArray.map((product, i)=>{
          return (
            <div className="col-xs-2-4 shopee-search-item-result__item" data-sqe="item">
                  <Link to={"/productdetail/"+product.id}><div className="tWpFe2">
                        ...
                        <div className="KMyn8J">
                          ...
                          <div className="hpDKMN">
                            ...
                            <div className="vioxXd rVLWG6">
                              <span className="ZEgDH9">{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(product.price)}</span>
                            </div>
                          </div>
          ...
          <div className="_9dX3ZL">
            <div className="container +eN62l">
              ...
              <div role="main" className="ZgwlcK">
                <div className="_1LtvMQ">
                  <a className="qBpeIZ K6GFxQ" href="/m/shopee-premium">
                    <div className="LxqF6b">
                      <div className="yvbeD6">
                        <img
                          width="invalid-value"
                          height="invalid-value"
                          className="X7rtqV vc8g9F"
                          style={{ objectFit: "contain" }}
                          src="https://cf.shopee.vn/file/66248d860f1088ce9cfa121cdb3315b4"
                        />
                      </div>
                      <div className="AVEdmi">
                        Shopee Premium - Hàng hiệu chính hãng
                      </div>
                      <svg
                        enableBackground="new 0 0 11 11"
                        viewBox="0 0 11 11"
                        x={0}
                        y={0}
                        className="shopee-svg-icon DM1bEl icon-arrow-right"
                      >
                    ...
                    <div className="yvbeD6">
                      <img
                        width="invalid-value"
                        height="invalid-value"
                        className="wkZ5C6 vc8g9F"
                        style={{ objectFit: "contain" }}
                        src="https://cf.shopee.vn/file/6c7bfe8eea08cfe0dab74021e6c551f2"
                      />
                    </div>
                  </a>
                </div>
                  ...
                  <div className="shopee-header-section shopee-header-section--simple">
                    <div className="shopee-header-section__header">
                      <div className="shopee-header-section__header__title">
                        ...
                        <span>
                          <span>"</span>
                          <span className="shopee-search-user-brief__header-text-highlight">
                            áo khoác
                          </span>
                          <span>"</span>
                        </span>
                      ...
                      <a
                        ...
                        tabIndex={-1}
                        href="/search_user?keyword=%C3%A1o%20kho%C3%A1c"
                      >
